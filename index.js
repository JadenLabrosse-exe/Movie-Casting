...
class MovieService {
    static url = 'https://crudcrud.com/api/ee19abbdb9ea4a31bdd2fbab656613dc';
    ...
    static createMovie(movie) {
        return $.ajax(this.url, {movies: "Batman"}, {"headers": {
...
class DOMManager {
    ...
    static addActor(id) {
        for (let movie of this.movies) {
            if(movie._id == id) {
                movie.actors.push(new Actor($(`#${movie._id}-actor-name`).val(), $(`#${movie._id}-actor-age`).val()));
